...
<style>
    ...
    .dash-page-eyebrow {
        ...
        color: var(--tx3); margin-bottom: 5px; display: flex; align-items: center; gap: 6px;
    }
    ...
    .dash-date {
        display: flex; align-items: center; gap: 7px; font-size: .8rem; color: var(--tx3); font-weight: 500;
        padding: 7px 14px; border-radius: 100px; background: var(--surface); border: 1px solid var(--border); white-space: nowrap;
    }
    ...
    .stat-card:nth-child(1) { animation-delay: .04s; } .stat-card:nth-child(2) { animation-delay: .09s; }
    .stat-card:nth-child(3) { animation-delay: .14s; } .stat-card:nth-child(4) { animation-delay: .19s; }
    ...
    .stat-card::after {
        ...
        border-radius: 50%; background: var(--stat-glow, rgba(44,95,46,.05)); pointer-events: none;
    }
    ...
    .stat-trend {
        display: inline-flex; align-items: center; gap: 3px; font-size: .7rem; font-weight: 700;
        padding: 3px 9px; border-radius: 100px;
    }
    .trend-up { background: rgba(34,197,94,.1); color: #16a34a; }
    .trend-down { background: rgba(239,68,68,.1); color: #ef4444; }
    .trend-neutral { background: var(--surface2); color: var(--tx3); }
    [data-theme="dark"] .trend-up { background: rgba(74,222,128,.12); color: #4ADE80; }
    [data-theme="dark"] .trend-down { background: rgba(252,165,165,.12); color: #FCA5A5; }
    ...
    .sec-card:nth-child(1) { animation-delay: .22s; } .sec-card:nth-child(2) { animation-delay: .28s; }
    .sec-card:nth-child(3) { animation-delay: .32s; } .sec-card:nth-child(4) { animation-delay: .36s; }
    .sec-head {
        display: flex; align-items: center; justify-content: space-between;
        padding: 18px 20px; border-bottom: 1px solid var(--border);
    }
    .sec-title {
        font-family: 'Playfair Display', serif; font-size: 1rem; font-weight: 700; color: var(--tx);
    ...
    .sec-link {
        display: inline-flex; align-items: center; gap: 4px; font-size: .76rem; font-weight: 600;
        color: var(--primary); padding: 5px 12px; border-radius: 100px; border: 1.5px solid transparent;
        transition: background .15s, border-color .15s; text-decoration: none;
    }
    .sec-link:hover { background: rgba(44,95,46,.06); border-color: rgba(44,95,46,.15); }
    [data-theme="dark"] .sec-link:hover { background: rgba(74,222,128,.07); border-color: rgba(74,222,128,.2); }
    ...
    .adm-table th {
        ...
        letter-spacing: .07em; color: var(--tx3); text-align: left; border-bottom: 1px solid var(--border);
    }
    .adm-table td {
        padding: 11px 16px; font-size: .84rem; color: var(--tx2); border-bottom: 1px solid var(--border); vertical-align: middle;
    }
    .adm-table tbody tr:last-child td { border-bottom: none; }
    .adm-table tbody tr:hover td { background: rgba(250,247,242,.6); }
    [data-theme="dark"] .adm-table tbody tr:hover td { background: rgba(40,39,31,.7); }
    .tbl-cover {
    ...
    .tbl-cat {
        ...
        color: var(--primary); background: rgba(44,95,46,.08); padding: 2px 8px; border-radius: 4px;
    }
    [data-theme="dark"] .tbl-cat { background: rgba(74,222,128,.1); }
    .tbl-views {
    ...
    .user-av {
        width: 38px; height: 38px; border-radius: 50%; background: rgba(44,95,46,.1);
        display: flex; align-items: center; justify-content: center; font-size: .85rem;
        font-weight: 700; color: var(--primary); flex-shrink: 0;
    }
    [data-theme="dark"] .user-av { background: rgba(74,222,128,.1); }
    .user-name { font-size: .85rem; font-weight: 600; color: var(--tx); }
    .user-email { font-size: .73rem; color: var(--tx3); margin-top: 1px; }
    .user-time {
        margin-left: auto; font-size: .72rem; color: var(--tx3); display: flex; align-items: center;
    ...
    <div class="bottom-row">
        <div class="sec-card">
            ...
            <table class="adm-table">
                <thead>
                    <tr><th>#</th><th>Buku</th><th>Kategori</th><th>Views</th><th>Rating</th></tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display:flex;align-items:center;gap:10px">
                                <div class="tbl-cover" style="background:linear-gradient(145deg,{{ $book->cover_color ?? '#2C5F2E' }},{{ $book->cover_color_dark ?? '#1d4220' }})"></div>
                                <div>
