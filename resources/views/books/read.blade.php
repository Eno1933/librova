...
<html lang="id"
      x-data="{
          ...
          nightMode: false,    // mode baca malam (latar kuning)
          toggleTheme() {
              this.dark = !this.dark;
...
<head>
    ...
    <style>
        :root {
            --nav-h: 0px; /* tidak ada navbar di halaman ini */
        }
        body {
            margin: 0;
        ...
        /* Mode baca malam: latar kuning hangat */
        .reader-stage.night-mode {
            background: #F5E6C8;
        }
        [data-theme="dark"] .reader-stage.night-mode {
            background: #3D3522;
        }
        ...
        /* Saat mode malam, canvas diberi filter sepia */
        .reader-stage.night-mode #pdf-canvas {
...
(function () {
    ...
    let scale       = 1.2;
    let rendering   = false;
    let nightMode   = false;   // mode baca malam
    ...
    function saveProgress() {
        localStorage.setItem('librova_last_page_' + BOOK_ID, currentPage);
    }

    function applyNightMode() {
        if (nightMode) {
            readerStage.classList.add('night-mode');
        } else {
            readerStage.classList.remove('night-mode');
        }
    }
