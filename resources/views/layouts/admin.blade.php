...
<head>
    ...
    ════════════════════════════════════════ */
        ...
        [data-theme="dark"] .adm-brand-icon {
            color: var(--bg);
        }

        .adm-brand:hover .adm-brand-icon {
        ...
        [data-theme="dark"] .adm-brand-badge {
        ...
        [data-theme="dark"] .adm-link.active {
            background: rgba(74, 222, 128, .1);
        }
        ...
        [data-theme="dark"] .adm-link-badge {
            color: var(--bg);
        }
...
<body>
    <div class="adm-wrap"
        ...
        <div class="adm-main">
            ...
            <header class="adm-header">
                ...
                z-index:70; padding:8px 0; max-height:360px; overflow-y:auto;">
                    ...
                    display:flex; align-items:center; justify-content:space-between;">
                      ...
                      border-bottom:1px solid var(--border);">
                            ...
                            background:{{ $notif->read_at ? 'var(--tx3)' : 'var(--primary)' }};
                            flex-shrink:0; opacity:{{ $notif->read_at ? '.4' : '1' }}"></div>
                            ...
                            <div style="padding:20px 16px; text-align:center; font-size:.82rem; color:var(--tx3);">
                                <i class="bi bi-bell-slash" style="font-size:1.2rem; display:block; margin-bottom:4px;"></i>
    ...
    <style>
        ...
        .adm-user-chip div button:hover {
