...
<head>
    ...
    <title>Daftar — Librova</title>
    @vite(['resources/css/app.css', 'resources/js/app.js'])
    <style>
        /* Gaya khusus halaman Register (mirip login) */
        .register-container {
            display: flex;
            min-height: 100vh;
        }
        ...
        .btn-register:hover { background: var(--primary-h); transform: translateY(-1px); }
        .btn-google {
            width: 100%;
            padding: 0.85rem;
            border-radius: 12px;
...
<div class="register-container">
    ...
    <div class="register-left">
        ...
        <div class="register-form">
            ...
            <div style="text-align:center; margin-bottom:2rem;">
                ...
                <p>Daftar untuk mulai membaca ribuan e-book.</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" required autofocus placeholder="Nama Anda">
                </div>
            ...
            <!-- Google Register (arahkan ke Google login/register) -->
            ...
            <p style="text-align:center; margin-top:2rem; color:var(--tx2);">
                Sudah punya akun?
                <a href="{{ route('login') }}" style="color:var(--primary); font-weight:600;">Masuk sekarang</a>
            </p>
        </div>
    </div>
    ...
    <div class="register-right">
        ...
        <div style="text-align:center; color:white; position:relative; z-index:1; max-width:80%;">
            ...
            <h2 style="font-family:'Playfair Display',serif; font-size:2.5rem; margin-bottom:1rem; line-height:1.2;">Mulai Perjalanan Membaca Anda</h2>
            <p style="font-size:1.1rem; opacity:0.9;">Dapatkan akses tak terbatas ke ribuan e‑book pilihan dan bergabunglah dengan komunitas pembaca.</p>
        </div>
    </div>
</div>
