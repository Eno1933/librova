...
@section('title', 'Edit Kategori — Admin Librova')
    ...
    <div class="form-card">
        <form action="{{ route('admin.categories.update', $category->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input class="form-input" type="text" name="icon" value="{{ old('icon', $category->icon) }}" placeholder="Contoh: 📚">
            </div>
            ...
            <div style="display:flex;gap:12px;justify-content:flex-end;">
                ...
                <button type="submit" class="btn-save"><i class="bi bi-check-lg"></i> Update Kategori</button>
            </div>
        </form>
    </div>
</div>
