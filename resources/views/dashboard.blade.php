...
═══════════════════════════════════════════════ */
    ...
    .dash-stat:hover {
        ...
        box-shadow: 0 2px 16px var(--shadow, rgba(44, 95, 46, .1));
    }
    ...
    [data-theme="dark"] .dash-search-btn {
        color: var(--bg, #141410);
    }

    .dash-search-btn:hover {
        background: var(--primary-h, #1d4220);
    }
    ...
    .dash-cats-scroll::-webkit-scrollbar {
        display: none;
    }
    ...
    [data-theme="dark"] .dash-cat-pill.active {
    ...
    .bk-card-d:nth-child(1) {
        animation-delay: .04s
    }

    .bk-card-d:nth-child(2) {
        animation-delay: .08s
    }

    .bk-card-d:nth-child(3) {
        animation-delay: .12s
    }

    .bk-card-d:nth-child(4) {
        animation-delay: .16s
    }

    .bk-card-d:nth-child(5) {
        animation-delay: .20s
    }

    .bk-card-d:nth-child(6) {
        animation-delay: .24s
    }

    .bk-card-d:nth-child(7) {
        animation-delay: .28s
    }

    .bk-card-d:nth-child(8) {
        animation-delay: .32s
    }

    .bk-card-d:nth-child(9) {
        animation-delay: .36s
    }

    .bk-card-d:nth-child(10) {
        animation-delay: .40s
    }

    .bk-card-d:nth-child(11) {
        animation-delay: .44s
    }

    .bk-card-d:nth-child(12) {
        animation-delay: .48s
    }
    ...
    .bk-card-d:hover .bk-cover-d::before {
        left: 130%;
    }
    ...
    [data-theme="dark"] .dash-empty-btn {
        color: var(--bg, #141410);
    }
    ...
    [data-theme="dark"] .dash-pagination .page-item.active .page-link {
        color: var(--bg);
    }
