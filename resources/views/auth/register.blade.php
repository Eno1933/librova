...
<head>
    ...
    <style>
    /* ─────────────────────────────────────
       REGISTER PAGE STYLES (mirip login)
    ───────────────────────────────────── */
...
<div class="auth-shell">
    ...
    <div class="auth-left">
        ...
        <div class="auth-card">
            ...
            {{-- Heading --}}
            <h1 class="auth-heading">Buat <em>akun</em> baru</h1>
            <p class="auth-sub">Daftar untuk mulai membaca ribuan e‑book dan bergabung dengan komunitas pembaca.</p>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="f-group">
                    ...
                    <div class="f-input-wrap">
                        ...
                        <input class="f-input" type="text" name="name" id="name"
                ...
                {{-- Konfirmasi Password --}}
                <div class="f-group">
                    <label class="f-label" for="password_confirmation">Konfirmasi Kata Sandi</label>
                    <div class="f-input-wrap">
                        <i class="bi bi-lock-fill"></i>
                        <input class="f-input" :type="showPwConf ? 'text' : 'password'"
                               name="password_confirmation" id="password_confirmation" required
                               placeholder="Ulangi kata sandi" autocomplete="new-password"
                               style="padding-right:42px">
                        <button type="button" class="pw-toggle" @click="showPwConf = !showPwConf" :title="showPwConf ? 'Sembunyikan' : 'Tampilkan'">
                            <i class="bi" :class="showPwConf ? 'bi-eye-slash' : 'bi-eye'"></i>
                        </button>
                    </div>
                </div>
