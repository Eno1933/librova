...
═══════════════════════════════════════════ */
    ...
    [data-theme="dark"] .books-chip.primary {
    ...
    @for($d =1; $d <=12; $d++) .bk-card-idx:nth-child({
            {
            $d
        }
    ...
    .bk-card-idx:hover .bk-cover-idx::before {
        left: 130%;
    }
    ...
    .bk-badge-idx.featured {
        left: 10px;
        background: var(--gold);
        color: #000;
    }

    .bk-badge-idx.new-tag {
        right: 10px;
    ...
    .bk-pagination .page-item .page-link:hover {
        border-color: var(--primary);
        color: var(--primary);
    }
    ...
    [data-theme="dark"] .bk-pagination .page-item.active .page-link {
        color: var(--bg);
    }
